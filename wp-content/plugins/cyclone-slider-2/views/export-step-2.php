...
<div class="wrap">
	...
	<?php if( empty($log_results['errors']) ): ?>
		...
		<p><?php _e('Your export file is ready. Click Download.', 'cycloneslider'); ?></p>
		<br /><br />
		<a class="button" href="<?php echo $export_page_url; ?>"><?php _e('Back', 'cycloneslider'); ?></a>
		<a class="button button-primary" href="<?php echo $zip_url; ?>"><?php _e('Download', 'cycloneslider'); ?></a>
	<?php else: ?>
		<ul>
